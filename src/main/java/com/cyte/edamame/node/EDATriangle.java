...
public class EDATriangle extends EDANode
{
    //// GLOBAL VARIABLES ////
    ...
    {
        this.triangle.setTranslateX(pos.GetLeftDouble());
        this.triangle.setTranslateY(pos.GetRightDouble());
    };

    public void SetRotate(double rot)
    {
        this.triangle.setRotate(rot);
    };
    ...
    {
        return new PairMutable(this.triangle.getTranslateX(), this.triangle.getTranslateY());
    };
    ...
    {
        return this.triangle.getRotate();
    };

    public Bounds GetBoundsLocal()
    {
        return this.triangle.getBoundsInLocal();
    };

    public Bounds GetBoundsParent()
    {
        return this.triangle.getBoundsInParent();
    };
    ...
    public void Rotate(double deltaY)
    {
        ...
        this.triangle.setRotate(this.triangle.getRotate() + angle);
    }

    public void NodeAdd()
    {
        this.editor.paneHolder.getChildren().add(1, this.triangle);
    };

    public void NodeRemove()
    {
        this.editor.paneHolder.getChildren().remove(this.triangle);
    };
    ...
    {
        Bounds boundsLocal = this.triangle.getBoundsInLocal();
    ...
    {
        Point2D newPos = this.triangle.localToParent(pos.GetLeftDouble(), pos.GetRightDouble());
    ...
    {
        return this.triangle.getBoundsInParent().contains(new Point2D(pos.GetLeftDouble(), pos.GetRightDouble()));
    }
    ...
    public void SnapPointsRefresh()
    {
        ...
        for (int i = 0; i < this.snapPoints.size(); i++)
        {
            ...
            {
                throw new java.lang.Error("ERROR: Encountered unrecognized snap point when refreshing EDATriangle snap points!");
            }
