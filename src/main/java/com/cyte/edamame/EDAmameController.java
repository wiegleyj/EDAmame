...
public class EDAmameController implements Initializable
{
    ...
    final static public Double EditorSymbol_RectWidthMax = 20.0;
    final static public Double EditorSymbol_RectHeightMin = 1.0;
    final static public Double EditorSymbol_RectHeightMax = 20.0;
    final static public Double EditorSymbol_TriLenMin = 1.0;
    final static public Double EditorSymbol_TriLenMax = 20.0;
